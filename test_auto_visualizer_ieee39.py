...
def run_auto_visualization(spacing_factor=2.0, node_size_factor=1.0,
    ...
    Args:
        spacing_factor: Controls component spread around buses (default=2.0)
    ...
    try:
        ...
        output = viz.draw_graphviz(
            filename="outputs/ieee39_graphviz_neato",
            layout_engine="neato",
            format="svg",
            show_impedance=True,
            show_voltage=True,
        ...
        #     output = viz.draw_graphviz(
        #         filename=f"outputs/ieee39_graphviz_{engine}",
        ...
        # viz.draw("outputs/ieee39_manual_hierarchical.svg", 
        ...
        # generated_files.append("outputs/ieee39_manual_hierarchical.svg")
        #
        # print("\n[MANUAL] Force-directed layout...")
        # viz.draw("outputs/ieee39_manual_force_directed.svg", 
        ...
        #         strict_component_clearance=strict_component_clearance,
        #         bus_clearance=bus_clearance)
        # generated_files.append("outputs/ieee39_manual_force_directed.svg")
        #
        ...
        # generated_files.append("outputs/ieee39_electrical_distance.svg")

        print("\n" + "="*70)
        print("[SUCCESS] Generated IEEE 39-bus visualization:")
